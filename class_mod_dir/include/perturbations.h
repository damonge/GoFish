...
enum smgqs_flags {smgqs_on_extreme, smgqs_on, smgqs_off, smgqs_on_again, smgqs_off_again};
...
struct perturbs
{
  ...
  short has_weak_lensing;     /**< do we need Cl's for galaxy lensing potential? */
  ...
  short has_lensing_shear; /**< in sCl, do we want lensing shear? */
  short has_intrinsic_alignment; /**< in sCl, do we want intrinsic alignments? */
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_f_cdm;	/**< do we need source for cold dark matter growth? */
  ...
  int index_tp_f_cdm;          /**< index value for cold dark matter growth factor */
...
extern "C" {
  ...
  int perturb_find_smgqs_intervals(struct precision * ppr,
                                   struct background * pba,
                                   struct perturbs * ppt,
                                   double k,
                                   double tau_ini,
