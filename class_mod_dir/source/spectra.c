...
#define _itt_in_range_(itt,index,num,flag) (flag == _TRUE_) && (itt >= index) && (itt < index+num)

static int spectra_get_index(struct spectra * psp,
			     struct transfers * ptr,
			     struct perturbs * ppt,
			     int index_md,int itt1,int itt2)
{
  int index_return;
  int id_nc,id_wl;
  int is_nc_1=0,is_nc_2=0;
  int is_wl_1=0,is_wl_2=0;
  int id1=-1,id2=-1,id_hi=-1,id_lo=-1;

  if((psp->has_tt==_TRUE_) &&
     (itt1==ptr->index_tt_tall) && (itt2==ptr->index_tt_tall))
    return psp->index_ct_tt;
  if((psp->has_ee==_TRUE_) &&
     (itt1==ptr->index_tt_eall) && (itt2==ptr->index_tt_eall))
    return psp->index_ct_ee;
  if((psp->has_te==_TRUE_) &&
     (((itt1==ptr->index_tt_tall) && (itt2==ptr->index_tt_eall)) ||
      ((itt1==ptr->index_tt_eall) && (itt2==ptr->index_tt_tall))))
    return psp->index_ct_te;

  if(_tensors_ && (psp->has_bb==_TRUE_) &&
     (itt1==ptr->index_tt_ball) && (itt2==ptr->index_tt_ball))
    return psp->index_ct_bb;

  if(_scalars_) {
    if((psp->has_pp==_TRUE_) && (itt1==ptr->index_tt_pall) && (itt2==ptr->index_tt_pall))
      return psp->index_ct_pp;
    if((psp->has_tp==_TRUE_) &&
       (((itt1==ptr->index_tt_tall) && (itt2==ptr->index_tt_pall)) ||
	((itt1==ptr->index_tt_pall) && (itt2==ptr->index_tt_tall))))
      return psp->index_ct_tp;
    if((psp->has_ep==_TRUE_) &&
       (((itt1==ptr->index_tt_eall) && (itt2==ptr->index_tt_pall)) ||
	((itt1==ptr->index_tt_pall) && (itt2==ptr->index_tt_eall))))
      return psp->index_ct_ep;
    
    if((_itt_in_range_(itt1,ptr->index_tt_ncall,ptr->selection_num_nc,ppt->has_cl_number_count))) {
      is_nc_1=1;
      id1=itt1-ptr->index_tt_ncall;
    }
    if((_itt_in_range_(itt2,ptr->index_tt_ncall,ptr->selection_num_nc,ppt->has_cl_number_count))) {
      is_nc_2=1;
      id2=itt2-ptr->index_tt_ncall;
    }
    if((_itt_in_range_(itt1,ptr->index_tt_wlall,ptr->selection_num_wl,ppt->has_weak_lensing))) {
      is_wl_1=1;
      id1=itt1-ptr->index_tt_wlall;
    }
    if((_itt_in_range_(itt2,ptr->index_tt_wlall,ptr->selection_num_wl,ppt->has_weak_lensing))) {
      is_wl_2=1;
      id2=itt2-ptr->index_tt_wlall;
    }

    //TD
    if((psp->has_td==_TRUE_) && is_nc_1 && (itt2==ptr->index_tt_tall))
      return psp->index_ct_td+id1;
    if((psp->has_td==_TRUE_) && is_nc_2 && (itt1==ptr->index_tt_tall))
      return psp->index_ct_td+id2;
    //PD
    if((psp->has_pd==_TRUE_) && is_nc_1 && (itt2==ptr->index_tt_pall))
      return psp->index_ct_pd+id1;
    if((psp->has_pd==_TRUE_) && is_nc_2 && (itt1==ptr->index_tt_pall))
      return psp->index_ct_pd+id2;
    //TL
    if((psp->has_tl==_TRUE_) && is_wl_1 && (itt2==ptr->index_tt_tall))
      return psp->index_ct_tl+id1;
    if((psp->has_tl==_TRUE_) && is_wl_2 && (itt1==ptr->index_tt_tall))
      return psp->index_ct_tl+id2;
    //PL
    if((psp->has_pl==_TRUE_) && is_wl_1 && (itt2==ptr->index_tt_pall))
      return psp->index_ct_pl+id1;
    if((psp->has_pl==_TRUE_) && is_wl_2 && (itt1==ptr->index_tt_pall))
      return psp->index_ct_pl+id2;
    
    //DD
    if((psp->has_dd==_TRUE_) && is_nc_1 && is_nc_2) {
      id_hi=MAX(id1,id2);
      id_lo=MIN(id1,id2);
      index_return=psp->index_ct_dd;
      index_return+=(id_lo*(2*psp->d_size_nc-id_lo+1))/2;
      //(psp->d_size_nc*(psp->d_size_nc+1)-(psp->d_size_nc-id_lo)*(psp->d_size_nc-id_lo+1))/2;
      index_return+=id_hi-id_lo;
      return index_return;
    }
    //LL
    if((psp->has_ll==_TRUE_) && is_wl_1 && is_wl_2) {
      id_hi=MAX(id1,id2);
      id_lo=MIN(id1,id2);
      index_return=psp->index_ct_ll;
      index_return+=(id_lo*(2*psp->d_size_wl-id_lo+1))/2;
      //(psp->d_size_wl*(psp->d_size_wl+1)-(psp->d_size_wl-id_lo)*(psp->d_size_wl-id_lo+1))/2;
      index_return+=id_hi-id_lo;
      return index_return;
    }
    //DL
    if((psp->has_dl==_TRUE_) && is_nc_1 && is_wl_2) {
      id_nc=id1;
      id_wl=id2;
      return psp->index_ct_dl+id_nc*psp->d_size_wl+id_wl;
    }
    //DL
    if((psp->has_dl==_TRUE_) && is_wl_1 && is_nc_2) {
      id_wl=id1;
      id_nc=id2;
      return psp->index_ct_dl+id_nc*psp->d_size_wl+id_wl;
    }
...
int spectra_init(
  ...
  if (ppt->has_cls == _TRUE_) {
    class_call(spectra_cls_mine(pba,ppt,ptr,ppm,psp),
    	       psp->error_message,
	       psp->error_message);
...
int spectra_indices(
  ...
  if (ppt->has_cls == _TRUE_) {
    ...
    if ((ppt->has_scalars == _TRUE_) && (ppt->has_cl_number_count == _TRUE_))
      psp->d_size_nc=ptr->selection_num_nc;
    else
      psp->d_size_nc=0;

    if ((ppt->has_scalars == _TRUE_) && (ppt->has_weak_lensing == _TRUE_))
      psp->d_size_wl=ptr->selection_num_wl;
    else
      psp->d_size_wl=0;
    ...
    if ((ppt->has_cl_number_count == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      ...
      index_ct+=psp->d_size_nc*(psp->d_size_nc+1)/2;
    }
    else {
      psp->has_dd = _FALSE_;
    }
    ...
    */
    ...
    if ((ppt->has_cl_cmb_lensing_potential == _TRUE_) && (ppt->has_weak_lensing == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      psp->has_pl = _TRUE_;
      psp->index_ct_pl=index_ct;
      index_ct+=psp->d_size_wl;
    }
    else {
      psp->has_pl = _FALSE_;
    }
    ...
    if ((ppt->has_weak_lensing == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      psp->has_ll = _TRUE_;
      psp->index_ct_ll=index_ct;
      index_ct+=psp->d_size_wl*(psp->d_size_wl+1)/2;
    }
    else {
      psp->has_ll = _FALSE_;
    }
    ...
    /* the computation of C_l^Tl would require a very good sampling of
       ...
       very inaccurate spectra.
    */
    if ((ppt->has_cl_cmb_temperature == _TRUE_) && (ppt->has_weak_lensing == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      psp->has_tl = _TRUE_;
    ...
    if ((ppt->has_cl_number_count == _TRUE_) && (ppt->has_weak_lensing == _TRUE_) && (ppt->has_scalars == _TRUE_)) {
      psp->has_dl = _TRUE_;
      psp->index_ct_dl=index_ct;
      index_ct+=psp->d_size_nc*psp->d_size_wl;
    }
    else {
      psp->has_dl = _FALSE_;
    }
    ...
    if (ppt->has_scalars == _TRUE_) {
      ...
      if (psp->has_pd == _TRUE_)
        for (index_ct=psp->index_ct_pd;
             index_ct<psp->index_ct_pd+psp->d_size_nc;
             index_ct++)
          psp->l_max_ct[ppt->index_md_scalars][index_ct] = MIN(ppt->l_scalar_max,ppt->l_lss_max);

      if (psp->has_pl == _TRUE_)
        for (index_ct=psp->index_ct_pl;
             index_ct<psp->index_ct_pl+psp->d_size_wl;
             index_ct++)
          psp->l_max_ct[ppt->index_md_scalars][index_ct] = MIN(ppt->l_scalar_max,ppt->l_lss_max);

      if (psp->has_ll == _TRUE_)
        for (index_ct=psp->index_ct_ll;
             index_ct<psp->index_ct_ll+psp->d_size_wl*(psp->d_size_wl+1)/2;
             index_ct++)
          psp->l_max_ct[ppt->index_md_scalars][index_ct] = ppt->l_lss_max;

      if (psp->has_tl == _TRUE_)
        for (index_ct=psp->index_ct_tl;
             index_ct<psp->index_ct_tl+psp->d_size_wl;
             index_ct++)
          psp->l_max_ct[ppt->index_md_scalars][index_ct] = MIN(ppt->l_scalar_max,ppt->l_lss_max);

      if (psp->has_dl == _TRUE_)
        for (index_ct=psp->index_ct_dl;
             index_ct<psp->index_ct_dl+psp->d_size_nc*psp->d_size_wl;
             index_ct++)
          psp->l_max_ct[ppt->index_md_scalars][index_ct] = ppt->l_lss_max;
...
int spectra_cls_mine(
  ...
  double * cl_integrand; /* array with argument cl_integrand[index_k*3+1] */
  double * primordial_pk;  /* array with argument primordial_pk[index_ic_ic]*/
  ...
  for (index_md = 0; index_md < psp->md_size; index_md++) {
    ...
    class_alloc(psp->ddcl[index_md],sizeof(double)*psp->l_size[index_md]*psp->ct_size*psp->ic_ic_size[index_md],psp->error_message);
#ifdef _CLASST_DEBUG
    unsigned long long d_tsize=sizeof(double)*psp->l_size[index_md]*
      ((unsigned long long)(psp->ct_size*psp->ic_ic_size[index_md]));
    double d_tsize_GB=(double)d_tsize/(1024.*1024.*1024.);
    printf("Mode %d : %.3lf GB for power spectra here\n",index_md,d_tsize_GB);
    printf("          ct_size = %d, l_size= %d, ic_ic_size= %d\n",
	   psp->ct_size,psp->l_size[index_md],psp->ic_ic_size[index_md]);
#endif //_CLASST_DEBUG
...
#pragma omp parallel					     \
  shared(ptr,ppm,index_md,psp,ppt,index_ic1,index_ic2,abort) \
  private(tstart,cl_integrand,primordial_pk,index_l,tstop)
          {
	    int itt1,itt2; //Running indices for each transfer type
...
#pragma omp for schedule (dynamic)
	      ...
	      //DAM: Is this really necessary
#pragma omp flush(abort)
	      for(itt1=0;itt1<ptr->tt_size_all[index_md];itt1++) {
		for(itt2=itt1;itt2<ptr->tt_size_all[index_md];itt2++) {
		  class_call_parallel(spectra_compute_cl_mine(pba,
							      ppt,
							      ptr,
							      ppm,
							      psp,
...
int spectra_compute_cl(
  ...
  double * transfer_ic1_wl=NULL;
  double * transfer_ic2_wl=NULL;
  double factor;
  int index_q_spline=0;

  double ell=(double)(psp->l[index_l]);

  index_ic1_ic2 = index_symmetric_matrix(index_ic1,index_ic2,psp->ic_size[index_md]);

  if (ppt->has_cl_number_count == _TRUE_) {
    class_alloc(transfer_ic1_nc,psp->d_size_nc*sizeof(double),psp->error_message);
    class_alloc(transfer_ic2_nc,psp->d_size_nc*sizeof(double),psp->error_message);
  }

  if (ppt->has_weak_lensing == _TRUE_) {
    class_alloc(transfer_ic1_wl,psp->d_size_wl*sizeof(double),psp->error_message);
    class_alloc(transfer_ic2_wl,psp->d_size_wl*sizeof(double),psp->error_message);
  }
  ...
  for (index_q=0; index_q < ptr->q_size; index_q++) {
    ...
    if(_scalars_ && ppt->has_weak_lensing == _TRUE_) {
      for(index_d1=0; index_d1<psp->d_size_wl; index_d1++) {
	transfer_ic1_wl[index_d1]=0.;
	transfer_ic2_wl[index_d1]=0.;
	
	if(ppt->has_intrinsic_alignment==_TRUE_) {
	  transfer_ic1_wl[index_d1]+=transfer_ic1[ptr->index_tt_alignment+index_d1];
	  transfer_ic2_wl[index_d1]+=transfer_ic2[ptr->index_tt_alignment+index_d1];
	}

	if(ppt->has_lensing_shear==_TRUE_) {
	  transfer_ic1_wl[index_d1]+=transfer_ic1[ptr->index_tt_lensing+index_d1];
	  transfer_ic2_wl[index_d1]+=transfer_ic2[ptr->index_tt_lensing+index_d1];
	}
	
	//Include l(l+1) factor in the lensing kernel
	transfer_ic1_wl[index_d1]*=sqrt((ell+2.)*(ell+1)*ell*(ell-1));
	transfer_ic2_wl[index_d1]*=sqrt((ell+2.)*(ell+1)*ell*(ell-1));
      }
    }

    if (_scalars_ && ppt->has_cl_number_count == _TRUE_) {
      for (index_d1=0; index_d1<psp->d_size_nc; index_d1++) {
        ...
        if (ppt->has_nc_rsd1    == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_rsd+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_rsd+index_d1];
	}
	if (ppt->has_nc_rsd2    ==_TRUE_) {
          transfer_ic1_nc[index_d1] +=transfer_ic1[ptr->index_tt_d0+index_d1];
          transfer_ic2_nc[index_d1] +=transfer_ic2[ptr->index_tt_d0+index_d1];
	}
	if (ppt->has_nc_rsd3    ==_TRUE_) {
          transfer_ic1_nc[index_d1] +=transfer_ic1[ptr->index_tt_d1+index_d1];
          transfer_ic2_nc[index_d1] +=transfer_ic2[ptr->index_tt_d1+index_d1];
	}

        if (ppt->has_nc_lens == _TRUE_) {
          transfer_ic1_nc[index_d1] += ell*(ell+1)*transfer_ic1[ptr->index_tt_nc_lens+index_d1];
          transfer_ic2_nc[index_d1] += ell*(ell+1)*transfer_ic2[ptr->index_tt_nc_lens+index_d1];
        }

        if (ppt->has_nc_gr1 == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_nc_g1+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_nc_g1+index_d1];
	}
        if (ppt->has_nc_gr2 == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_nc_g2+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_nc_g2+index_d1];
	}
        if (ppt->has_nc_gr3 == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_nc_g3+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_nc_g3+index_d1];
	}
        if (ppt->has_nc_gr4 == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_nc_g4+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_nc_g4+index_d1];
	}
        if (ppt->has_nc_gr5 == _TRUE_) {
          transfer_ic1_nc[index_d1] += transfer_ic1[ptr->index_tt_nc_g5+index_d1];
          transfer_ic2_nc[index_d1] += transfer_ic2[ptr->index_tt_nc_g5+index_d1];
	}
    ...
    */
    ...
    if (_scalars_ && (psp->has_dd == _TRUE_)) {
      index_ct=0;
      for (index_d1=0; index_d1<psp->d_size_nc; index_d1++) {
        for (index_d2=index_d1; index_d2<psp->d_size_nc; index_d2++) {
    ...
    if (_scalars_ && (psp->has_pl == _TRUE_)) {
      for (index_d1=0; index_d1<psp->d_size_wl; index_d1++) {
        cl_integrand[index_q*cl_integrand_num_columns+1+psp->index_ct_pl+index_d1]=
          primordial_pk[index_ic1_ic2]
          * 0.5*(transfer_ic1[ptr->index_tt_lcmb] * transfer_ic2_wl[index_d1] +
		 transfer_ic2[ptr->index_tt_lcmb] * transfer_ic1_wl[index_d1])
          * factor;
      }
    }
    ...
    if (_scalars_ && (psp->has_ll == _TRUE_)) {
      index_ct=0;
      for (index_d1=0; index_d1<psp->d_size_wl; index_d1++) {
        for (index_d2=index_d1; index_d2<psp->d_size_wl; index_d2++) {
          cl_integrand[index_q*cl_integrand_num_columns+1+psp->index_ct_ll+index_ct]=
            primordial_pk[index_ic1_ic2]
            * transfer_ic1_wl[index_d1]
            * transfer_ic2_wl[index_d2]
            * factor;
          index_ct++;
        }
      }
    ...
    if (_scalars_ && (psp->has_tl == _TRUE_)) {
      for (index_d1=0; index_d1<psp->d_size_wl; index_d1++) {
        cl_integrand[index_q*cl_integrand_num_columns+1+psp->index_ct_tl+index_d1]=
          primordial_pk[index_ic1_ic2]
          * 0.5*(transfer_ic1_temp * transfer_ic2_wl[index_d1] +
                 transfer_ic1_wl[index_d1] * transfer_ic2_temp)
          * factor;
      }
    }
    ...
    if (_scalars_ && (psp->has_dl == _TRUE_)) {
      index_ct=0;
      for (index_d1=0; index_d1<psp->d_size_nc; index_d1++) {
        for (index_d2=0; index_d2<psp->d_size_wl; index_d2++) {
          cl_integrand[index_q*cl_integrand_num_columns+1+psp->index_ct_dl+index_ct]=
            primordial_pk[index_ic1_ic2]
            * 0.5*(transfer_ic1_nc[index_d1] * transfer_ic2_wl[index_d2] +
		   transfer_ic2_nc[index_d1] * transfer_ic1_wl[index_d2])
            * factor;
          index_ct++;
        }
      }
  ...
  for (index_ct=0; index_ct<psp->ct_size; index_ct++) {
	...
	(_tensors_ && (psp->has_pl == _TRUE_) && (index_ct == psp->index_ct_pl)) ||
  ...
  if (ppt->has_weak_lensing == _TRUE_) {
    free(transfer_ic1_wl);
    free(transfer_ic2_wl);
  }
			    ...
			    int itt1,int itt2)
{
  ...
  index_ct=spectra_get_index(psp,ptr,ppt,index_md,itt1,itt2);
  if(index_ct<0)
    return _SUCCESS_;
  index_ic1_ic2 = index_symmetric_matrix(index_ic1,index_ic2,psp->ic_size[index_md]);
  ...
  if ((_scalars_ && (psp->has_bb == _TRUE_) && (index_ct == psp->index_ct_bb)) ||
    ...
    /* for non-zero spectra, integrate over q */
    for (index_q=0; index_q < ptr->q_size; index_q++) {
      double tr_i1_t1,tr_i1_t2,tr_i2_t1,tr_i2_t2;

      k = ptr->k[index_md][index_q];
      cl_integrand[index_q*3+0] = k;
      class_call(primordial_spectrum_at_k(ppm,index_md,linear,k,primordial_pk),
		 ppm->error_message,
		 psp->error_message);
      /* integrand of Cl's */
      ...
      */
      ...
      tr_i1_t1=ptr->transfer_all[index_md][((index_ic1*ptr->tt_size_all[index_md]+itt1)
					    *ptr->l_size[index_md]+index_l)
					   *ptr->q_size+index_q];
      tr_i1_t2=ptr->transfer_all[index_md][((index_ic1*ptr->tt_size_all[index_md]+itt2)
					    *ptr->l_size[index_md]+index_l)
					   *ptr->q_size+index_q];
      tr_i2_t1=ptr->transfer_all[index_md][((index_ic2*ptr->tt_size_all[index_md]+itt1)
					    *ptr->l_size[index_md]+index_l)
					   *ptr->q_size+index_q];
      tr_i2_t2=ptr->transfer_all[index_md][((index_ic2*ptr->tt_size_all[index_md]+itt2)
					    *ptr->l_size[index_md]+index_l)
					   *ptr->q_size+index_q];

      cl_integrand[index_q*3+1]=factor*primordial_pk[index_ic1_ic2]*
	0.5*(tr_i1_t1*tr_i2_t2+tr_i1_t2*tr_i2_t1);
    }
    ...
    */
    if (pba->sgnK == 1) {
      clvalue += cl_integrand[1]*ptr->q[0]/ptr->k[0][0]*sqrt(pba->K)/2.;
    }
    
    /* we have the correct C_l now. We can store it in the transfer structure. */
    psp->cl[index_md][(index_l*psp->ic_ic_size[index_md]+index_ic1_ic2)*psp->ct_size+index_ct]=clvalue;
  }
...
int spectra_pk(
  ...
  if (psp->spectra_verbose>0)
    fprintf(stdout," -> sigma8=%.10lf (computed till k = %g h/Mpc)\n",
            psp->sigma8,
            exp(psp->ln_k[psp->ln_k_size-1])/pba->h);
    
    
  double sigma100, sigma_rs, del2_100, del2_rs;
  
  class_call(spectra_sigma(pba,ppm,psp,100./pba->h,0.,&(sigma100)),
             psp->error_message,
             psp->error_message);    
  
  class_call(spectra_delta2(pba,ppm,psp,pba->h*2.*_PI_/100.,0.,&(del2_100)),
             psp->error_message,
             psp->error_message);
  
  //Note: use the drag sound horizon pth->rs_d!
  
  class_call(spectra_sigma(pba,ppm,psp,pba->rs_d,0.,&(sigma_rs)),
             psp->error_message,
             psp->error_message);    
  
  class_call(spectra_delta2(pba,ppm,psp,2.*_PI_/pba->rs_d,0.,&(del2_rs)),
             psp->error_message,
             psp->error_message); 
  
  if (psp->spectra_verbose>1){
    fprintf(stdout," -> sigma_100=%g, sigma_rs_d=%g \n",
            sigma100,sigma_rs);     
    fprintf(stdout," -> <delta^2>(2pi/100)=%g, <delta^2>(2pi/rs_d)=%g  (rs_d=%g Mpc) \n",
            del2_100,del2_rs,pba->rs_d);     
  }
...
/**
 * This routine computes <delta^2>(Lambda) given P(k) (does not check that k_max is large
 * enough)
 *
 * @param pba     Input: pointer to background structure
 * @param ppm     Input: pointer to primordial structure
 * @param psp     Input: pointer to spectra structure
 * @param z       Input: redhsift
 * @param Lambda  Input: momentum cutoff in 1/Mpc
 * @param delta2  Output: variance up to a cutoff Lambda
 */
...
int spectra_delta2(
  ...
  class_alloc(array_for_delta2,
              psp->ln_k_size*index_num*sizeof(double),
              psp->error_message);

  if (Lambda > exp(psp->ln_k[psp->ln_k_size-1]))
    printf("spectra_delta2: asked for Lambda > k_max\n");
  ...
  for (i=0;i<psp->ln_k_size;i++) {
    ...
    class_call(spectra_pk_at_k_and_z(pba,ppm,psp,k,z,&pk,pk_ic),
               psp->error_message,
               psp->error_message);
    array_for_delta2[i*index_num+index_k]=k;
    array_for_delta2[i*index_num+index_y]=k*k*pk*W;
  }

  class_call(array_spline(array_for_delta2,
                          index_num,
                          psp->ln_k_size,
                          index_k,
                          index_y,
  ...
  class_call(array_integrate_all_spline(array_for_delta2,
                                        index_num,
                                        psp->ln_k_size,
                                        index_k,
                                        index_y,
  ...
  free(array_for_delta2);

  if (psp->ic_ic_size[psp->index_md_scalars]>1)
    free(pk_ic);

  *delta2 = *delta2/(2.*_PI_*_PI_);
