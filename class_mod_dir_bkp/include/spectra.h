...
struct spectra {
  ...
  int has_pl; /**< do we want C_l^phi-l ? */
  ...
  int index_ct_dd; /**< first index for type C_l^dd */
  int index_ct_td; /**< first index for type C_l^Td (d_size_nc values) */
  int index_ct_pd; /**< first index for type C_l^pd (d_size_nc values) */
  int index_ct_pl; /**< first index for type C_l^pl (d_size_nc values) */
  int index_ct_ll; /**< first index for type C_l^ll */
  int index_ct_tl; /**< first index for type C_l^Tl (d_size_wl values) */
  int index_ct_dl; /**< first index for type C_l^dl (d_size_nc*d_size_wl values) */
